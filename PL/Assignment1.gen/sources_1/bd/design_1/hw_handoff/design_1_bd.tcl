...
proc create_root_design { parentCell } {
  ...
  # Create instance: bram_store_0, and set properties
  ...
  connect_bd_net -net bram_store_0_bram_addrb [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins bram_store_0/bram_addrb]
  connect_bd_net -net bram_store_0_bram_dinb [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins bram_store_0/bram_dinb]
  connect_bd_net -net bram_store_0_bram_enb [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins bram_store_0/bram_enb]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins clk_divider_0/clk]
  connect_bd_net -net clk_divider_0_clk_div [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins bram_store_0/clk] [get_bd_pins clk_divider_0/clk_div] [get_bd_pins rx_mod_0/clk]
  ...
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins bram_store_0/rst_n] [get_bd_pins clk_divider_0/rst] [get_bd_pins rx_mod_0/rst]
  connect_bd_net -net rx_1 [get_bd_ports rx] [get_bd_pins rx_mod_0/sin]
  connect_bd_net -net rx_mod_0_data_out [get_bd_pins bram_store_0/uart_data] [get_bd_pins rx_mod_0/data_out] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins bram_store_0/uart_data_valid] [get_bd_pins xlconstant_0/dout]
