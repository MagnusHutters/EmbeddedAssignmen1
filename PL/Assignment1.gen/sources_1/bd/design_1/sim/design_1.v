...
module design_1
  ...
  wire [31:0]bram_store_0_bram_addrb;
  wire [31:0]bram_store_0_bram_dinb;
  wire bram_store_0_bram_enb;
  wire clk_1;
  ...
  design_1_blk_mem_gen_0_1 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(bram_store_0_bram_addrb),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(clk_divider_0_clk_div),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(bram_store_0_bram_dinb),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(bram_store_0_bram_enb),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(rst_1),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(xlconstant_1_dout));
  design_1_bram_store_0_0 bram_store_0
       (.bram_addrb(bram_store_0_bram_addrb),
        .bram_dinb(bram_store_0_bram_dinb),
        .bram_enb(bram_store_0_bram_enb),
        .clk(clk_divider_0_clk_div),
        .rst_n(rst_1),
        .uart_data(rx_mod_0_data_out),
        .uart_data_valid(xlconstant_0_dout));
